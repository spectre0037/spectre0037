...
<div align="center">
<img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/spectre0037/spectre0037/output/github-contribution-grid-snake-dark.svg" width="100%"/>
</div>
> ⚙️ **One-time setup required:** this image doesn't exist until the GitHub Action below runs once in this repo — see the *Snake Setup* section at the bottom. After that first run it's always there, no dark/light switching, and it auto-refreshes every 6 hours.
